...
def validate_module_behavior() -> None:
    ...
    both = MmWaveFusionSnapshot("room_delta", True, True)
    mmwave_only = MmWaveFusionSnapshot("room_delta", True, False)
    frigate_only = MmWaveFusionSnapshot("room_delta", False, True)
    none = MmWaveFusionSnapshot("room_delta", False, False)
    sleeping = MmWaveFusionSnapshot("room_alpha", True, True, sleeping=True)
    bed_motion = MmWaveFusionSnapshot("room_alpha", True, True, sleeping=True, bed_motion_only=True)
