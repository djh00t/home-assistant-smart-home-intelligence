# Security and retention jobs (phase 4 planning-only)

## Scope

- Provide a deterministic retention audit report for phase 4 artifacts.
...
- Cleanup is always dry-run for phase 4 hardening.
